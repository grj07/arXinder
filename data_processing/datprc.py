...
#Loops through the subject areas, pausing to overcome
#query limit from arXiv API
get_new_entries(subjects[0],subjects)
print("Entries for "+subjects[0] +" downloaded")
for ii in range(len(subjects)-1):
    time.sleep(3)
    get_new_entries(subjects[ii+1],subjects)
    print("Entries for "+subjects[ii+1] +" downloaded")
