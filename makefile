output: object 
	...
	rm *.o
object:	
	gcc -c -g c_source/utils.c 
	gcc -c -g c_source/nav.c c_source/menu.c c_source/nc_utils.c -Wno-unused-result -Wsign-compare -march=x86-64 -mtune=generic -O3 -pipe -fno-plt -fexceptions -Wp,-D_FORTIFY_SOURCE=2 -fstack-clash-protection -fcf-protection -flto=auto -ffat-lto-objects -DNDEBUG -g -fwrapv -O3 -Wall
